...
function Home(){
    return(
        ...
        <div >
            <h1 className="home-hero">We are a company of professional Electrical Engineers,Technicians, Welding Experts, Plumbing Experts and many more.. that's dedicated to provide you
to solve your problems at your homes. <span className="hero-h1"> We are just One Call Away</span>
</h1>
